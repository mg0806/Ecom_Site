    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-sm space-y-6 text-gray-800">
        <p>
          ...
          anywhere on this page shall mean <strong>MANOHAR GUPTA</strong>, whose
          registered/operational office is{" "}
          <strong>
            PLOT NO.19, 1/4,G.I.D.C. RANOLI, N.H No.8, Vadodara GUJARAT 391350
          </strong>
          .{" "}
          <strong>
            &quot;you&quot;, &quot;your&quot;, &quot;user&quot;,
